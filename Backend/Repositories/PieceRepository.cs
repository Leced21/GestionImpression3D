...
namespace Backend.Repositories
{
    public class PieceRepository : IPieceRepository
    {
        ...
        public async Task<Piece?> UpdateAsync(int id, Piece piece)
        {
            ...
            existingPiece.PoidsProduitGrammes = piece.PoidsProduitGrammes;
            existingPiece.Stock = piece.Stock;
            existingPiece.ImageUrl = piece.ImageUrl;
            existingPiece.EstDisponible = piece.EstDisponible;
            existingPiece.NomCommercial = piece.NomCommercial;
            existingPiece.SloganProduit = piece.SloganProduit;
            existingPiece.AccrocheMarketing = piece.AccrocheMarketing;
            existingPiece.DescriptionMarketing = piece.DescriptionMarketing;
            existingPiece.HauteurCm = piece.HauteurCm;
            existingPiece.OuvertureCm = piece.OuvertureCm;
            existingPiece.MatiereMarketing = piece.MatiereMarketing;
            existingPiece.EstEtanche = piece.EstEtanche;
            existingPiece.UtilisationProduit = piece.UtilisationProduit;
            existingPiece.ConseilsEntretien = piece.ConseilsEntretien;
            existingPiece.ColorisDisponibles = piece.ColorisDisponibles;
            existingPiece.BeneficesMarketing = piece.BeneficesMarketing;
