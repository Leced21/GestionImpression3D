...
{
    /// <inheritdoc />
    public partial class AddPieceVersions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrototype = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PieceVersions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PieceVersions_Pieces_PieceId",
                        column: x => x.PieceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PieceVersions_PieceId_VersionNumber",
                table: "PieceVersions",
                columns: new[] { "PieceId", "VersionNumber" },
                unique: true);
